...
-(void)setLastUrlString:(NSString *)lastUrlString
{
  ...
  [NELivePlayerController setLogLevel:NELP_LOG_DEFAULT];
    ...
    {
        self.player = [[NELivePlayerController alloc] initWithContentURL:[NSURL URLWithString:_lastUrlString]];
    }
}
...
RCT_EXPORT_METHOD(getStatus:(RCTResponseSenderBlock)callback)
{
  ...
  callback(@[[NSNull null],@{@"status":status,@"currentTime":currentTime,@"duration":duration,@"url":self.lastUrlString}]);
}

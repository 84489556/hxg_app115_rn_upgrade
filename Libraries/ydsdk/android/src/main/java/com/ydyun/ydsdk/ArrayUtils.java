...
//    }
    ...
    public static String toCodesStr(java.util.List<yuanda.DataDefine.SortEntity> entities){
        String str = "";
    ...
    public static String toCodesStr(String[] entities){
        String str = "";
        for (int i=0; i<entities.length; i++) {
            str = str.concat(entities[i]);
     ...
     */
    public static Map<String, String[]> CompareStringArray(String oldStr, String newStr) {
        String[] oldArr=oldStr.split(",");
        String[] newArr=newStr.split(",");
        return CompareStringArray(oldArr,newArr);
    }
    /**
     * @param oldArr 旧数组
     * @param newArr 新数组
    ...
    public static Map<String, String[]> CompareStringArray(String[] oldArr, String[] newArr){
        ...
        if(oldArr!=null) {
            for (String anOldArr : oldArr) {
                if (newArr==null||!ArrayUtils.contains(newArr, anOldArr)) {
        ...
        if(newArr!=null) {
            for (String aNewArr : newArr) {
                if (oldArr==null||!ArrayUtils.contains(oldArr, aNewArr)) {
                    addList.add(aNewArr);
                }
            }
        }

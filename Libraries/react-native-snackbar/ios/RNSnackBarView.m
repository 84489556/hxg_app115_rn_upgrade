...
- (instancetype)init
{
    self = [super initWithFrame:CGRectMake(0, 108, [UIScreen mainScreen].bounds.size.width, 30)];
    if (self) {
        [self buildView];
    }
    return self;
...
- (void)buildView {
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-5-[titleLabel]-5-|" options:0 metrics:nil views:@{@"titleLabel": titleLabel}]];
     [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-5-[titleLabel]-5-|" options:0 metrics:nil views:@{@"titleLabel": titleLabel}]];
...
- (void)presentWithDuration:(NSNumber*)duration {
    ...
    [self setFrame:CGRectMake(0,64,keyWindow.frame.size.width,30)];
...
- (void)show {
    ...
    titleLabel.textColor=[UIColor colorWithHexString:_pendingOptions[@"textColor"]];

    ...
    handleLongPress = e => {
        this.refs.view.measure(
            (frameX, frameY, frameWidth, frameHeight, pageX, pageY) => {
                ...
                this.props.onRowActive && this.props.onRowActive({
                    layout,
                    touch: e.nativeEvent,
    ...
    render() {
        ...
        const Row = React.cloneElement(
            this.props.renderRow(
                ...
                //null, //注释
                this.handleLongPress,//改为
                this.props.active
            ),
            {
                sortHandlers: {
                    // onPressIn: this.handleLongPress,//改为
                    // onLongPress: this.handleLongPress,//注释
        ...
        return (
            <View ref="wrapper" style={{ flex: 1 }} collapsable={false}>
              <FlatList
                  ...
                  renderItem={({item, index, separators}) => this.renderRow(item, 's1', index, () => {})}

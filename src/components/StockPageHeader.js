...
export default class PageHeader extends BaseComponent {
    ...
    styleSheet = StyleSheet.create({
        ...
        title: {
            textAlign: 'center',
            color: baseStyle.WHITE, //baseStyle.HEADER_FONT_COLOR,
            fontSize: 17
        },
        rightComponent: {
            flexDirection: 'row',
        ...
        return (
            typeof this.props.onBack === 'function' && (
                <View style={[this.getStyles('backButton')]}>
                    ...
                    >
                        <Image
                            source={require('../images/icons/icon_back.png')}
                            style={{ width: 9, height: 16, marginLeft: 15 }}
                        />
                    </TouchableOpacity>
                </View>
            )
    ...
    _renderTitle() {
        if (React.isValidElement(this.props.title)) {
            ...
            return (
                <Text
                    style={[this.getStyles('title'), { fontWeight: 'bold' }]}
                    numberOfLines={1}
                >
                    {this.props.title}
                </Text>
    ...
    render() {
        ...
        return (
            <View
                style={[
                    {
                        backgroundColor: '#fff', //baseStyle.TABBAR_BORDER_COLOR,
                        height:
                            Platform.OS == 'ios'
                        ...
                        borderBottomWidth: 0,
                        paddingTop:
                            Platform.OS == 'ios' ? statusBarHeightDP : null // statusBar填充
                    },
                    this.props.style
                ]}
            >
                {Platform.OS == 'ios' ? null : (
                    ...
                    >
                        <Image
                            resizeMode={'stretch'}
                        // source={require('../images/userCneter/status_bar_bg.png')}
                        />
                    </View>
                )}
                <View
                ...
                <TabBar
                    ...
                    style={{
                        ...
                        tabBarItemLabelSelected: {
                            color: baseStyle.TABBAR_BORDER_COLOR
                        }
                    }}

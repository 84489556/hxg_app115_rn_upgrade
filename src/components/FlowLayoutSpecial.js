 ...
 * date：2019/8/1 17
 * description: 一行带标签的布局(只用于研报策略的标签，因为样式特殊)
 * tagDatas:数组的数据
...
const styles = StyleSheet.create({
    container: {
        width:ScreenUtil.screenW-ScreenUtil.scaleSizeW(40),
    ...
    tag: {
       // width:ScreenUtil.scaleSizeW(112),
        ...
        paddingHorizontal:Platform.OS==='ios'?ScreenUtil.scaleSizeW(12):ScreenUtil.scaleSizeW(16),
        backgroundColor:"white",
        flexDirection:"row",

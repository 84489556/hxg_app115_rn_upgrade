...
RCT_EXPORT_METHOD(lockToPortrait)
{
  ...
  [[NSOperationQueue mainQueue] addOperationWithBlock:^ {
    [[UIDevice currentDevice] setValue:[NSNumber numberWithInteger: UIInterfaceOrientationLandscapeRight] forKey:@"orientation"];//旋转不动问题
...
RCT_EXPORT_METHOD(lockToLandscape)
{
  ...
  if ([orientationStr isEqualToString:@"LANDSCAPE-LEFT"]) {
    ...
    [[NSOperationQueue mainQueue] addOperationWithBlock:^ {
      [[UIDevice currentDevice] setValue:[NSNumber numberWithInteger: UIInterfaceOrientationPortrait] forKey:@"orientation"];//旋转不动问题

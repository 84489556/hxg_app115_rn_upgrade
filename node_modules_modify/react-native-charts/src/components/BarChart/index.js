      ...
      return dataSet.data.map((data, index) => {
        return (
          <View style={{ flex: 1, flexDirection: 'column' }}>
            ...
            <View style={{ flex: 1 }}><Text style={{ fontSize: 10, color: '#999999', textAlign: 'center' }}>{data.price}</Text></View>
            ...
            <View style={{ flex: 1 }}><Text style={{ fontSize: 10, color: '#999999', textAlign: 'center' }}>{data.name}</Text></View>
